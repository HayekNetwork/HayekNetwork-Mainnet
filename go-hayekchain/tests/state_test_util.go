...
// See https://github.com/hayekchain/EIPs/issues/176 for the test format specification.
...
func MakePreState(db hykdb.Database, accounts core.GenesisAlloc, snapshotter bool) (*snapshot.Tree, *state.StateDB) {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/hayekchain/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
