...
// Package tests implements execution of HayekChain JSON tests.
package tests
...
/* See https://github.com/hayekchain/tests/wiki/Blockchain-Tests-II

   Whhyker a block is valid or not is a bit subtle, it's defined by presence of
