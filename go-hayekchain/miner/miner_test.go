...
// TestMinerSetHayekerbase checks that hykerbase becomes set even if mining isn't
// possible at the moment
func TestMinerSetHayekerbase(t *testing.T) {
	miner, mux := createMiner(t)
...
func createMiner(t *testing.T) (*Miner, *event.TypeMux) {
	// Create Hayekash config
	config := Config{
		Hayekerbase: common.HexToAddress("123456789"),
	}
	// Create chainConfig
	memdb := memorydb.New()
