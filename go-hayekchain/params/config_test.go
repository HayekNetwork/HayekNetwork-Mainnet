...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllHayekashProtocolChanges, new: AllHayekashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllHayekashProtocolChanges, new: AllHayekashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllHayekashProtocolChanges,
