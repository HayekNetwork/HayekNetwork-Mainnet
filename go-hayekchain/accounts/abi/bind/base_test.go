...
func (mc *mockCaller) CallContract(ctx context.Context, call hayekchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call hayekchain.CallMsg) ([]byte, error) {
