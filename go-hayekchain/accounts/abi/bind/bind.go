...
// Package bind generates HayekChain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-hayekchain Wiki page:
// https://github.com/hayekchain/go-hayekchain/wiki/Native-DApps:-Go-bindings-to-HayekChain-contracts
package bind
...
func bindStructTypeGo(kind abi.Type, structs map[string]*tmplStruct) string {
	...
	case abi.TupleTy:
		...
		// toghyker here. The reason is before solidity v0.5.11, kind.TupleRawName
		// is empty, so we use canonical parameter expression to distinguish
		// different struct definition. From the consideration of backward
		// compatibility, we concat these two toghyker so that if kind.TupleRawName
