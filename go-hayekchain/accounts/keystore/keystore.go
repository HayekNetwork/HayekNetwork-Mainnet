...
// See https://github.com/hayekchain/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whhyker the event notification loop is running
...
// ImportPreSaleKey decrypts the given HayekChain presale wallet and stores
