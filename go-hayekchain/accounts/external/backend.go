...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain hayekchain.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to hayekchain-type signature.
		signature[64] -= 27 // Transform V from HayekChain-legacy to 0/1
	}
