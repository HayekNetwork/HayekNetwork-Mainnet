...
# 1. install ghyk for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for ghyk
# 5. create ghyk, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable HAYEKCHAIN_SOCKET
...
!define GROUPNAME "HayekChain"
!define APPNAME "Ghyk"
!define DESCRIPTION "Official Go implementation of the HayekChain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since ghyk is installed global
