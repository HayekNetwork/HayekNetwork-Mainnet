Name "ghyk ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/hayekchain/go-hayekchain/issues"
!define UPDATEURL "https://github.com/hayekchain/go-hayekchain/releases"
!define ABOUTURL "https://github.com/hayekchain/go-hayekchain#hayekchain-go"
...
# Install ghyk binary
Section "Ghyk" GHYK_IDX
  SetOutPath $INSTDIR
  file {{.Ghyk}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\ghyk.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\ghyk.exe" "attach"
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Ghyk incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\ghyk.exe" "" "" "HayekChain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Ghyk outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\ghyk.exe" "" "" "HayekChain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Ghyk UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\ghyk.exe" "" "" "HayekChain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/hayekchain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "HAYEKCHAIN_SOCKET" "R" "HKLM" "\\.\pipe\ghyk.ipc"
  ${EnvVarUpdate} $0 "HAYEKCHAIN_SOCKET" "A" "HKLM" "\\.\pipe\ghyk.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GHYK_IDX}
    SectionGetSize ${GHYK_IDX} $0
