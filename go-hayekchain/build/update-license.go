...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/hayekchain/go-hayekchain/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-hayekchain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-hayekchain Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-hayekchain"
	}
	if startOfSentence {
		return "The go-hayekchain library"
	}
	return "the go-hayekchain library"
}
