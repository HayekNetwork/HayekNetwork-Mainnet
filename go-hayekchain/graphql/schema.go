...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte HayekChain address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an HayekChain account at a particular block.
    type Account {
    ...
    # Log is an HayekChain event log.
    type Log {
    ...
    # Transaction is an HayekChain transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an HayekChain account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an HayekChain account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an HayekChain block by number or by hash. If neither is
