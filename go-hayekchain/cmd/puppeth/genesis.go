...
import (
	...
	math2 "github.com/hayekchain/go-hayekchain/common/math"
...
// newAlethGenesisSpec converts a go-hayekchain genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only hykash is currently supported between go-hayekchain and aleth
	if genesis.Config.Hayekash == nil {
	...
	spec.Params.BlockReward = (*hexutil.Big)(hykash.FrontierBlockReward)
...
type parityChainSpecPricing struct {
	...
	// Before the https://github.com/paritytech/parity-hayekchain/pull/11039,
...
// newParityChainSpec converts a go-hayekchain genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only hykash is currently supported between go-hayekchain and Parity
	if genesis.Config.Hayekash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	...
	spec.Engine.Hayekash.Params.BlockReward = make(map[string]string)
	spec.Engine.Hayekash.Params.DifficultyBombDelays = make(map[string]string)
	// Frontier
	spec.Engine.Hayekash.Params.MinimumDifficulty = (*hexutil.Big)(params.MinimumDifficulty)
	spec.Engine.Hayekash.Params.DifficultyBoundDivisor = (*hexutil.Big)(params.DifficultyBoundDivisor)
	spec.Engine.Hayekash.Params.DurationLimit = (*hexutil.Big)(params.DurationLimit)
	spec.Engine.Hayekash.Params.BlockReward["0x0"] = hexutil.EncodeBig(hykash.FrontierBlockReward)

	// Homestead
	spec.Engine.Hayekash.Params.HomesteadTransition = hexutil.Uint64(genesis.Config.HomesteadBlock.Uint64())

	// Tangerine Whistle : 150
	// https://github.com/hayekchain/EIPs/blob/master/EIPS/eip-608.md
	spec.Params.EIP150Transition = hexutil.Uint64(genesis.Config.EIP150Block.Uint64())

	// Spurious Dragon: 155, 160, 161, 170
	// https://github.com/hayekchain/EIPs/blob/master/EIPS/eip-607.md
	...
	// ghyk has it set from zero
	spec.Params.MaxCodeSizeTransition = 0

	// Disable this one
	spec.Params.EIP98Transition = math.MaxInt64

	spec.Genesis.Seal.HayekChain.Nonce = types.EncodeNonce(genesis.Nonce)
	spec.Genesis.Seal.HayekChain.MixHash = (genesis.Mixhash[:])
	spec.Genesis.Difficulty = (*hexutil.Big)(genesis.Difficulty)
	spec.Genesis.Author = genesis.Coinbase
	spec.Genesis.Timestamp = (hexutil.Uint64)(genesis.Timestamp)
	spec.Genesis.ParentHash = genesis.ParentHash
...
func (spec *parityChainSpec) setByzantium(num *big.Int) {
	spec.Engine.Hayekash.Params.BlockReward[hexutil.EncodeBig(num)] = hexutil.EncodeBig(hykash.ByzantiumBlockReward)
	spec.Engine.Hayekash.Params.DifficultyBombDelays[hexutil.EncodeBig(num)] = hexutil.EncodeUint64(3000000)
	n := hexutil.Uint64(num.Uint64())
	spec.Engine.Hayekash.Params.EIP100bTransition = n
...
func (spec *parityChainSpec) setConstantinople(num *big.Int) {
	spec.Engine.Hayekash.Params.BlockReward[hexutil.EncodeBig(num)] = hexutil.EncodeBig(hykash.ConstantinopleBlockReward)
	spec.Engine.Hayekash.Params.DifficultyBombDelays[hexutil.EncodeBig(num)] = hexutil.EncodeUint64(2000000)
	n := hexutil.Uint64(num.Uint64())
...
// pyHayekChainGenesisSpec represents the genesis specification format used by the
// Python HayekChain implementation.
type pyHayekChainGenesisSpec struct {
	Nonce      types.BlockNonce  `json:"nonce"`
	Timestamp  hexutil.Uint64    `json:"timestamp"`
	ExtraData  hexutil.Bytes     `json:"extraData"`
	GasLimit   hexutil.Uint64    `json:"gasLimit"`
...
// newPyHayekChainGenesisSpec converts a go-hayekchain genesis block into a Parity specific
// chain specification format.
func newPyHayekChainGenesisSpec(network string, genesis *core.Genesis) (*pyHayekChainGenesisSpec, error) {
	// Only hykash is currently supported between go-hayekchain and pyhayekchain
	if genesis.Config.Hayekash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	spec := &pyHayekChainGenesisSpec{
