...
// Tests the go-hayekchain to Aleth chainspec conversion for the Stureby testnet.
func TestAlethSturebyConverter(t *testing.T) {
	blob, err := ioutil.ReadFile("testdata/stureby_ghyk.json")
	if err != nil {
	...
	expBlob, err := ioutil.ReadFile("testdata/stureby_alhyk.json")
	if err != nil {
		t.Fatalf("could not read file: %v", err)
	}
...
// Tests the go-hayekchain to Parity chainspec conversion for the Stureby testnet.
