...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage HayekChain presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    ghyk wallet import /path/to/my/presale.wallet

will prompt for your password and imports your hyker presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import HayekChain presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	ghyk wallet [options] /path/to/my/presale.wallet
...
between hayekchain nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    ghyk account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    ghyk account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another hayekchain instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := ghykConfig{Node: defaultNodeConfig()}
	// Load config file.
