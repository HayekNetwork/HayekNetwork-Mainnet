...
func TestAccountListEmpty(t *testing.T) {
	ghyk := runGhyk(t, "--nousb", "account", "list")
	ghyk.ExpectExit()
}

func TestAccountList(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	ghyk := runGhyk(t, "--nousb", "account", "list", "--datadir", datadir)
	defer ghyk.ExpectExit()
...
func TestAccountNew(t *testing.T) {
	ghyk := runGhyk(t, "account", "new", "--lightkdf")
	defer ghyk.ExpectExit()
	ghyk.Expect(`
...
func importAccountWithExpect(t *testing.T, key string, expected string) {
	...
	ghyk := runGhyk(t, "account", "import", keyfile, "-password", passwordFile)
	defer ghyk.ExpectExit()
	ghyk.Expect(expected)
}
...
func TestAccountUpdate(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	ghyk := runGhyk(t, "--nousb", "account", "update",
...
func TestWalletImport(t *testing.T) {
	ghyk := runGhyk(t, "--nousb", "wallet", "import", "--lightkdf", "testdata/guswallet.json")
	defer ghyk.ExpectExit()
	ghyk.Expect(`
!! Unsupported terminal, password will be echoed.
...
`)
	...
	files, err := ioutil.ReadDir(filepath.Join(ghyk.Datadir, "keystore"))
	if len(files) != 1 {
...
func TestUnlockFlag(t *testing.T) {
	ghyk := runMinimalGhyk(t, "--port", "0", "--ipcdisable", "--datadir", tmpDatadirWithKeystore(t),
...
`)
	...
	for _, m := range wantMessages {
		if !strings.Contains(ghyk.StderrText(), m) {
...
// https://github.com/hayekchain/go-hayekchain/issues/1785
...
func TestUnlockFlagAmbiguous(t *testing.T) {
	...
	ghyk.SetTemplateFunc("keypath", func(file string) string {
