...
var (
	...
	LegacyMinerHayekerbaseFlag = cli.StringFlag{
		Name:  "hykerbase",
		Usage: "Public address for block mining rewards (default = first account, deprecated, use --miner.hykerbase)",
		Value: "0",
	}
