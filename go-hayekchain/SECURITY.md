...
Audit reports are published in the `docs` folder: https://github.com/hayekchain/go-hayekchain/tree/master/docs/audits 


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `ghyk` | 20170425 | [pdf](https://github.com/hayekchain/go-hayekchain/blob/master/docs/audits/2017-04-25_Ghyk-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/hayekchain/go-hayekchain/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
...
To find out how to disclose a vulnerability in HayekChain visit [https://bounty.hayekchain.org](https://bounty.hayekchain.org) or email bounty@hayekchain.org.
