...
creating a collection of devp2p nodes, connecting them toghyker to form a
...
As a concrete example, consider a simulated network of HayekChain nodes. An
