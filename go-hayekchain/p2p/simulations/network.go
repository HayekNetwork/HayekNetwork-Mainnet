...
// starting nodes and connecting them toghyker.
//
...
// Connect connects two nodes toghyker by calling the "admin_addPeer" RPC
...
func (n *Node) UnmarshalJSON(raw []byte) error {
	...
	// Ticket: https://github.com/hykersphere/go-hayekchain/issues/1177
	var node struct {
		Config *adapters.NodeConfig `json:"config,omitempty"`
		Up     bool                 `json:"up"`
	}
