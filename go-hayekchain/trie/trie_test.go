...
func (s *spongeDb) NewBatch() hykdb.Batch                    { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) hykdb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w hykdb.KeyValueWriter) error { return nil }
