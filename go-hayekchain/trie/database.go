...
type Database struct {
	diskdb hykdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb hykdb.KeyValueStore) *Database {
...
func NewDatabaseWithConfig(diskdb hykdb.KeyValueStore, config *Config) *Database {
...
func (db *Database) DiskDB() hykdb.KeyValueStore {
	return db.diskdb
}
...
// are referenced toghyker by database itself.
...
func (db *Database) commit(hash common.Hash, batch hykdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
