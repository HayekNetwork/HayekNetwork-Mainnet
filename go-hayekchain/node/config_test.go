...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ghyk.ipc", false, filepath.Join(os.TempDir(), "ghyk.ipc")},
		{"data", "ghyk.ipc", false, "data/ghyk.ipc"},
		{"data", "./ghyk.ipc", false, "./ghyk.ipc"},
		{"data", "/ghyk.ipc", false, "/ghyk.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ghyk.ipc", true, `\\.\pipe\ghyk.ipc`},
		{"data", "ghyk.ipc", true, `\\.\pipe\ghyk.ipc`},
		{"data", `\\.\pipe\ghyk.ipc`, true, `\\.\pipe\ghyk.ipc`},
	}
