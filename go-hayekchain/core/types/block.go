...
// Package types contains data types related to HayekChain consensus.
package types
...
// Header represents a block header in the HayekChain blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) toghyker.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the HayekChain blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package hyk to track
...
// [deprecated by hyk/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for hyk protocol, etc.
...
// DecodeRLP decodes the HayekChain
...
// EncodeRLP serializes b into the HayekChain RLP block format.
