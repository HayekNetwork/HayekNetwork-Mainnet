...
// that address/topic, and binary AND-ing those vectors toghyker.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them toghyker
				var orVector []byte
...
// the requested retrieval queue to be serviced toghyker with other sessions.
//
