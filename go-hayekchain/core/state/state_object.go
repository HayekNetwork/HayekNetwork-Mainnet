...
// stateObject represents an HayekChain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of hayekchain address of the account
	data     Account
	db       *StateDB
...
// Account is the HayekChain consensus representation of accounts.
