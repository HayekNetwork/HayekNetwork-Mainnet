...
func generateSnapshot(diskdb hykdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, wiper chan struct{}) *diskLayer {
...
func journalProgress(db hykdb.KeyValueWriter, marker []byte, stats *generatorStats) {
...
// ghykering and logging, since the method surfs the blocks as they arrive, often
// being restarted.
func (dl *diskLayer) generate(stats *generatorStats) {
	...
	for accIt.Next() {
		...
		if batch.ValueSize() > hykdb.IdealBatchSize || abort != nil {
