...
// SnapshotTree is an HayekChain state snapshot tree. It consists of one persistent
...
type Tree struct {
	diskdb hykdb.KeyValueStore      // Persistent database to store the snapshot
...
func New(diskdb hykdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool, recovery bool) *Tree {
