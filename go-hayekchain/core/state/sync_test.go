...
// account array.
func checkStateAccounts(t *testing.T, db hykdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db hykdb.Database, root common.Hash) error {
...
func checkStateConsistency(db hykdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(hykdb.Database), srcRoot)
