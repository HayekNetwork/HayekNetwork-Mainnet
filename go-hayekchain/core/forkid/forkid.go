...
// Package forkid implements EIP-2124 (https://eips.hayekchain.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the HayekChain fork ID from the chain config, genesis hash, and head.
