...
func ReadDatabaseVersion(db hykdb.KeyValueReader) *uint64 {
	var version uint64
...
func WriteDatabaseVersion(db hykdb.KeyValueWriter, version uint64) {
...
func ReadChainConfig(db hykdb.KeyValueReader, hash common.Hash) *params.ChainConfig {
...
func WriteChainConfig(db hykdb.KeyValueWriter, hash common.Hash, cfg *params.ChainConfig) {
	if cfg == nil {
		return
	}
