...
//   reserving it for go-hayekchain. This would also reduce the memory requirements
//   of Ghyk, and thus also GC overhead.
type freezer struct {
...
func (f *freezer) freeze(db hykdb.KeyValueStore) {
