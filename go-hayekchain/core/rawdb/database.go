...
import (
	...
	"github.com/hayekchain/go-hayekchain/hykdb/leveldb"
	"github.com/hayekchain/go-hayekchain/hykdb/memorydb"
...
func NewDatabase(db hykdb.KeyValueStore) hykdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db hykdb.KeyValueStore, freezer string, namespace string) (hykdb.Database, error) {
...
func NewMemoryDatabase() hykdb.Database {
...
func NewMemoryDatabaseWithCap(size int) hykdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (hykdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (hykdb.Database, error) {
...
func InspectDatabase(db hykdb.Database) error {
