...
func NewTable(db hykdb.Database, prefix string) hykdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) hykdb.Iterator {
...
func (t *table) NewBatch() hykdb.Batch {
...
func (b *tableBatch) Replay(w hykdb.KeyValueWriter) error {
