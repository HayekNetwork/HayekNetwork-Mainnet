...
import (
	...
	"github.com/hayekchain/go-hayekchain/crypto/blake2b"
	"github.com/hayekchain/go-hayekchain/crypto/bls12381"
	"github.com/hayekchain/go-hayekchain/crypto/bn256"
...
// PrecompiledContractsHomestead contains the default set of pre-compiled HayekChain
...
// PrecompiledContractsByzantium contains the default set of pre-compiled HayekChain
...
// PrecompiledContractsIstanbul contains the default set of pre-compiled HayekChain
...
// PrecompiledContractsYoloV2 contains the default set of pre-compiled HayekChain
...
func (c *bigModExp) RequiredGas(input []byte) uint64 {
	...
	if c.eip2565 {
		...
		// in EIP-2565 (https://eips.hayekchain.org/EIPS/eip-2565):
		//
		// def mult_complexity(x):
		//    ceiling(x/8)^2
		//
