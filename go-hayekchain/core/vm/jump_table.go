...
func newYoloV2InstructionSet() JumpTable {
	...
	enable2315(&instructionSet) // Subroutines - https://eips.hayekchain.org/EIPS/eip-2315
	enable2929(&instructionSet) // Access lists for trie accesses https://eips.hayekchain.org/EIPS/eip-2929
...
func newIstanbulInstructionSet() JumpTable {
	...
	enable1344(&instructionSet) // ChainID opcode - https://eips.hayekchain.org/EIPS/eip-1344
	enable1884(&instructionSet) // Reprice reader opcodes - https://eips.hayekchain.org/EIPS/eip-1884
	enable2200(&instructionSet) // Net metered SSTORE - https://eips.hayekchain.org/EIPS/eip-2200
