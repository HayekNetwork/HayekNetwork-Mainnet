...
type BlockContext struct {
	...
	// sufficient hyker to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers hyker from one account to the other
...
// EVM is the HayekChain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) hayekchain virtual machine
...
func (evm *EVM) CallCode(caller ContractRef, addr common.Address, input []byte, gas uint64, value *big.Int) (ret []byte, leftOverGas uint64, err error) {
	...
	// Fail if we're trying to transfer more than the available balance
	// Note although it's noop to transfer X hyker to caller itself. But
