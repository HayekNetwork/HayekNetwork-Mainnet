 ...
 * @author Gary Rong<garyrong@hayekchain.org>, Martin Swende <martin.swende@hayekchain.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the hayekchain.
    uint sectionSize;
