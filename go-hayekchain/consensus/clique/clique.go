...
// ecrecover extracts the HayekChain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the HayekChain address
...
// HayekChain testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     hykdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // HayekChain address of the signing key
...
func New(config *params.CliqueConfig, db hykdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the HayekChain address recovered
