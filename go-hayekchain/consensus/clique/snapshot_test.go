...
// mapped from textual names used in the tests below to actual HayekChain private
...
// address retrieves the HayekChain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the HayekChain address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/hayekchain/go-hayekchain/issues/17593). Whilst this
