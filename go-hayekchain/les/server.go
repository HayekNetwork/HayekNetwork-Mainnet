...
type LesServer struct {
	...
	archiveMode bool // Flag whether the hayekchain node runs in archive mode.
...
func NewLesServer(node *node.Node, e *hyk.HayekChain, config *hyk.Config) (*LesServer, error) {
