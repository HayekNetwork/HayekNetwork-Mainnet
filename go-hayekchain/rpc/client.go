...
const (
	...
	subscribeTimeout   = 5 * time.Second  // overall timeout hyk_subscribe, rpc_modules calls
)
...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for HykSubscribe requests
}
...
// HykSubscribe registers a subscripion under the "hyk" namespace.
func (c *Client) HykSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "hyk", channel, args...)
}
