...
//
// hyk_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// hyk_subscribe("newHeads")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.HykSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	err = client.CallContext(ctx, &lastBlock, "hyk_getBlockByNumber", "latest", false)
	if err != nil {
