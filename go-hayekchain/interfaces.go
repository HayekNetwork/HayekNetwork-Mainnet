...
// Package hayekchain defines interfaces for interacting with HayekChain.
package hayekchain
...
type FilterQuery struct {
	BlockHash *common.Hash     // used by hyk_getLogs, return logs only from block with this hash
