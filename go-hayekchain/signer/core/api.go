...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*hykapi.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx hykapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*hykapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := hykapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
