...
// Syncing provides information when this nodes starts synchronising with the HayekChain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  hayekchain.SyncProgress `json:"status"`
}
