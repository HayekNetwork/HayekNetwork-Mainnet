...
// PeerInfo represents a short summary of the HayekChain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // HayekChain protocol version negotiated
...
//
// This method is legacy support for initial transaction exchange in hyk/64 and
// prior. For hyk/65 and higher use SendPooledTransactionHashes.
...
// Handshake executes the hyk protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("hyk/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the HayekChain sub-protocol.
type peerSet struct {
