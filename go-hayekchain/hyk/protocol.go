...
const protocolName = "hyk"

// ProtocolVersions are the supported versions of the hyk protocol (first is primary).
var ProtocolVersions = []uint{hyk65, eth64, eth63}

// protocolLengths are the number of implemented message corresponding to different protocol versions.
var protocolLengths = map[uint]uint64{hyk65: 17, eth64: 17, eth63: 17}

const protocolMaxMsgSize = 10 * 1024 * 1024 // Maximum cap on the size of a protocol message

// hyk protocol message codes
const (
	StatusMsg          = 0x00
	...
	// New protocol message codes introduced in hyk65
	//
	// Previously these message ids were used by some legacy and unsupported
	// hyk protocols, reown them here.
...
// statusData63 is the network packet for the status message for hyk/63.
...
// statusData is the network packet for the status message for hyk/64 and later.
